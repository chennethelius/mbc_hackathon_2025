...
contract MarketFactory {
    ...
    function createMarketWithBettors(
        ...
        // Create market first using internal function
        address marketAddress = _createMarket(friend1, friend2, title, resolutionTime);
    ...
    function createMarket(
        ...
        return _createMarket(friend1, friend2, title, resolutionTime);
    }
